...
class Patient:
    ...
    inflammatory_arthritis: Optional[bool] = None
    ibd: Optional[bool] = None
    hiv: Optional[bool] = None
    stable_art: Optional[bool] = None
    osa: Optional[bool] = None
    masld: Optional[bool] = None
    south_asian_ancestry: Optional[bool] = None
    filipino_ancestry: Optional[bool] = None
    higher_risk_ancestry_context: Optional[str] = None
    active_cancer: Optional[bool] = None
    cancer_survivor: Optional[bool] = None
    cancer_life_expectancy_gt_2y: Optional[bool] = None
